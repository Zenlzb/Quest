...
const newQuest = (id, title, dueDate, points, status, priority, requirePhoto, photoURL) => ({id, title, dueDate, points, status, priority, requirePhoto, photoURL})
